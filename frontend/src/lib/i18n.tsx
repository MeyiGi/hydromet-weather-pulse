...
const T = {
  en: {
    ...
    enterSynop: "Enter the 24-character encrypted SYNOP code.",
  ...
  ru: {
    ...
    enterSynop: "Введите 24-символьный зашифрованный код SYNOP.",
  ...
  kg: {
    ...
    enterSynop: "24 белгилүү SYNOP кодун киргизиңиз.",
